...
# Note: handle_flight_update is called from edit_flight route with request/session params
# Using version from helpers.py for this functionality


# Note: handle_crew_update is called from edit_flight route with request param
# Using version from helpers.py for this functionality

# generate_seats_for_plane is imported from helpers.py - uses the version with existence check
...
def edit_flight(flight_number):
    ...
    if request.method == 'POST':
        ...
        # Call helper functions with request/session params
